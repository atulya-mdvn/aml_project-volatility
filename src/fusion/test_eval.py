...
p1 = pd.read_csv("data/processed/p1_latent.csv", index_col=0, parse_dates=True)
p2 = pd.read_csv("data/processed/p2_transformer.csv", index_col=0, parse_dates=True)
p3 = pd.read_csv("data/processed/p3_finbert.csv", index_col=0, parse_dates=True)
p4 = pd.read_csv("data/processed/p4_gat.csv", index_col=0, parse_dates=True)
