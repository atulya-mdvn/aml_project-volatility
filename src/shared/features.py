...
def build_features(spx, vix_raw, spx_intraday=None, options_df=None):
    print("=" * 60)
    ...
    # skip options features — snapshot only, not historical time series
    # collect daily snapshots over time to build usable features
